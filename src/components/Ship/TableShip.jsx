  ...
  return (
    <TableHead>
      <TableRow>
        <TableCell>
          <Tooltip title="Crear">
            <IconButton component={Link} to="/ship/crear/">
              <AddIcon />
            </IconButton>
          </Tooltip>
        </TableCell>
                    ...
                    .map((row, index) => {
                      ...
                      return (
                        ...
                        {/* Contenido de la tabla que muestra el nombre, dias, destino*/}
                          ...
                          <TableCell align="left">{row.guestCapacity}</TableCell>
                          <TableCell align="left">{row.availableRoomCount}</TableCell>
