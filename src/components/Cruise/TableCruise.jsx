...
//Encabezado tabla
function TableCruiseHead(props) {
  ...
  return (
    <TableHead>
      <TableRow>
        <TableCell>
          <Tooltip title="Crear">
            <IconButton component={Link} to="/cruise/crear/">
              <AddIcon />
            </IconButton>
          </Tooltip>
        </TableCell>
...
//Barra de opciones
function TableCruiseToolbar(props) {
  const { numSelected } = props;
  const { idSelected } = props;
  const navigate = useNavigate();
  //Realiza la acción de actualizar
  const update = () => {
    return navigate(`/cruise/update/${idSelected}`);
  };
  //Realiza la acción para llanar a detalle
  const info = () => {
    return navigate(`/cruise/${idSelected}`);
  };
  return (
    <Toolbar
      sx={{
                    ...
                    .map((row, index) => {
                      ...
                      return (
                        ...
                        {/* Contenido de la tabla que muestra el nombre, dias, destino*/}
                          ...
                          <TableCell align="left">{row.destinationId}</TableCell>
